...
const ReviewAndSubmit = ({ 
  ...
  const renderFeeDocsInfo = () => (
    <div className="review-submit__content-grid">
      ...
      <div className="review-submit__content-column">
        <div className="review-submit__info-item">
          <span className="review-submit__info-label">Initial Payment:</span>
          <span className="review-submit__info-value">₹{formData.feeDocs?.initialPaymentAmount || 'Not provided'}</span>
        </div>
      </div>
    </div>
  );
  ...
  return (
    <div className="review-submit">
      ...
      <div className="review-submit__progress">
        <div className="review-submit__progress-steps">
          <div className="review-submit__step review-submit__step--completed">
            <div className="review-submit__step-icon">👤</div>
          ...
          <div className="review-submit__step review-submit__step--active">
            <div className="review-submit__step-icon">✅</div>
